...
alternatives_compare_array = np.mat([[1, 5, 9],
                                     [1/5, 1, 4],
                                     [1/9, 1/4, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(1, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 4, 1 / 5],
                                     [1/4, 1, 1/9],
                                     [5, 9, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(2, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 9, 4],
                                     [1/9, 1, 1/4],
                                     [1/4, 4, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(3, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 1, 1],
                                     [1, 1, 1],
                                     [1, 1, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(4, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 6, 4],
                                     [1/6, 1, 1/3],
                                     [1/4, 3, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(5, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 9, 6],
                                     [1/9, 1, 1/3],
                                     [1/6, 3, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(6, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 1 / 2, 1 / 2],
                                     [2, 1, 1],
                                     [2, 1, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(7, alternatives_compare_array)

alternatives_compare_array = np.mat([[1, 1 / 7, 1 / 5],
                                     [7, 1, 3],
                                     [5, 1/3, 1]])
relative_measurement.set_alternatives_compare_matrixes_elements(8, alternatives_compare_array)
